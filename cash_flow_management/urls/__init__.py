...
from cash_flow_management.urls.auth_urls import rest_auth_urls
from cash_flow_management.urls.swagger_urls import swagger_urlpatterns
from cash_flow_management.urls.versioned_urls import versioned_urls
